...
//                 // Calculate curved layout properties - more seats in middle rows
//                 const rowWidth = seatsByRow[row].length * 36; // Base width calculation
//                 const curveAmount = Math.abs(rowIndex - (rows.length / 2)) * 0.05;
...
//                         .map((seat, seatIndex) => {
//                           // Create gaps for aisles (adjust as needed for layout)
